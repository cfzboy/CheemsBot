...
async def reedme(e):
    await e.edit(
        ...
        "\n[Setup Guide - Basic](https://t.me/CheemsUserbot/98)"
        "\n[Setup Guide - Google Drive](https://t.me/CheemsUserbot/98)"
        "\n[Setup Guide - LastFM Module](https://t.me/CheemsUserbot/98)"
        "\n[Video Tutorial - 576p](https://t.me/CheemsUserbot/127)"
        "\n[Video Tutorial - 1080p](https://t.me/CheemsUserbot/127)"
    )
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "Click [here](https://github.com/ashisharmy/CheemsBot) to open the bot's GitHub page."
    )
